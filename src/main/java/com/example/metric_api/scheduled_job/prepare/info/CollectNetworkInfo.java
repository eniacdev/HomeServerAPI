...
import com.example.metric_api.dto.NetworkInfoResponse;
...
@Component
public class CollectNetworkInfo {
    public NetworkInfoResponse collectNetworkInfo(){
        
        SystemInfo si = new SystemInfo();
        HardwareAbstractionLayer hal = si.getHardware();
        List<NetworkIF> netwoIFs = hal.getNetworkIFs();
        NetworkInfoResponse networkInfo = new NetworkInfoResponse();
