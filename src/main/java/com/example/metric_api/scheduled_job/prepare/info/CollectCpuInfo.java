...
import com.example.metric_api.dto.CpuInfoResponse;
...
public class CollectCpuInfo {
    ...
    public CpuInfoResponse collectCpuInfo(){

        CpuInfoResponse cpuInfo = new CpuInfoResponse();
    ...
    private void checkInfo(CpuInfoResponse cpuInfo){
