...
import com.example.metric_api.dto.UptimeMetricResponse;

@Component
public class CollectUptimeInfo {
	
	public UptimeMetricResponse collectUptimeMetric() throws Exception{
		
		RuntimeMXBean rb = ManagementFactory.getRuntimeMXBean();
		long uptime = rb.getUptime();
		
		UptimeMetricResponse upTimeMetricDto = new UptimeMetricResponse();
